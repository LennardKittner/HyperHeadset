...
SUBSYSTEMS=="usb", ATTRS{idProduct}=="173f", ATTRS{idVendor}=="0951", MODE="0666"
SUBSYSTEMS=="usb", ATTRS{idProduct}=="1740", ATTRS{idVendor}=="0951", MODE="0666"
...
KERNEL=="hidraw*", ATTRS{idProduct}=="173f", ATTRS{idVendor}=="0951", MODE="0666"
KERNEL=="hidraw*", ATTRS{idProduct}=="1740", ATTRS{idVendor}=="0951", MODE="0666"
```
